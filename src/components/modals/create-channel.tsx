...
function CreateChannel() {
    ...
    const mutation = trpc.channel.createChannel.useMutation();
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        mutation.mutate({
            ...
            onSuccess(res) {
                utils.server.getServer.setData({ serverId: params?.serverId as string }, (oldData: ServerwithMembersWithProfile) => {
